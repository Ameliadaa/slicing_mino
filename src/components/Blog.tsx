...
const blogPosts: BlogPost[] = [
  {
    ...
    author: 'Admin',
    comments: 3,
    excerpt: 'Laiknya diri sendiri, sepatu juga butuh dirawat. Seti- daknya setiap sebulan sekali, sepatu perlu dibersih- kan. Namun pembersihan tergantung jenis bahan se...',
    imageUrl: Blog1,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    author: 'Admin',
    comments: 2,
    excerpt: 'Jogging atau lari-lari pendek menjadi salah satu tren olahraga di tengah pandemi. Namun, sayangnya tren ini diikuti oleh pelari pemula.',
    imageUrl: Blog3,
  },
];
    ...
    <div className='container mx-auto px-5 py-12  md:px-16 lg:px-20' >
      ...
      <div className="flex flex-col md:flex-row md:gap-4 mt-8">
        {blogPosts.map((post) => (
          <div
            key={post.id}
            className="mb-6 md:mb-0 bg-white rounded-lg shadow-md overflow-hidden md:flex-1"
          >
            <Image
              src={post.imageUrl}
              alt={post.title}
            ...
            />
            <div className="p-4">
              <span className="text-xs font-semibold text-primary-theme uppercase">
                {post.category}
              </span>
              <h3 className="text-lg font-semibold mt-2">{post.title}</h3>
              <div className="text-xs text-tersier-theme mt-2 uppercase">
              ...
              <Button variant='primary' className="mt-4 inline-block text-sm md:text-base">
                Baca Selengkapnya
              </Button>
            </div>
          </div>
