  ...
  return (
    <div className="relative w-full h-64 md:h-80 lg:h-96 mt-4 ">
      ...
      <div className="absolute inset-0 bg-black bg-opacity-30 flex items-center ">
        <div className="text-white flex flex-col justify-start text-left md:flex-row md:justify-between items-center ml-8 md:container md:mx-auto  md:px-16 lg:px-20 space-y-4 md:space-y-0 md:space-x-4 px-4">
          <div>
